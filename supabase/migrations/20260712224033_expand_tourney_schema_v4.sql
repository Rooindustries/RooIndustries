...
revoke all on function public.roo_capture_tourney_hardening_snapshot(jsonb,jsonb)
  from public, anon, authenticated;
grant execute on function public.roo_capture_tourney_hardening_snapshot(jsonb,jsonb)
  to service_role;
