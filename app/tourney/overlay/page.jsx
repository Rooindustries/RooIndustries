      ...
      >
        <div className="ov-docs-grid">
          ...
          <OverlaySourceCard
            ...
            recommendedSize="Any size — the bracket fits the frame automatically. 1920×1080 for the full tree, or a smaller source with ?group= for one lane"
            params={BRACKET_PARAMS}
            previewSrc="/tourney/overlay/bracket?bg=gradient"
            previewHeight={560}
          />
          <OverlaySourceCard
