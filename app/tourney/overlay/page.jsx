...
const BRACKET_PARAMS = [
  ...
  {
    name: "?scale=1",
    text: "Zoom the whole overlay (0.35–2, default 1). The full 12-team bracket fits 1920×1080 at about 0.55; a single lane fits near 0.8.",
  },
  {
    name: "?group=winners",
      ...
      >
        <div className="ov-docs-grid">
          ...
          <OverlaySourceCard
            ...
            recommendedSize="1920×1080 with ?scale=0.55 for the full bracket, or 1920×1080 near scale 1 with ?group= for one lane"
