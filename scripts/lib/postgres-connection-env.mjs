...
const optionalParameters = new Map([
  ["channel_binding", {
    ...
    allowed: new Set(["disable", "prefer", "require"]),
  }],
  ["sslmode", {
    key: "PGSSLMODE",
...
export const buildPostgresConnectionEnv = (databaseUrl, baseEnv = process.env) => {
  let parsed;
  try {
...
export const buildPostgresSessionArgs = (args = []) => [
  "--no-password",
  "-X",
  "--set=ON_ERROR_STOP=1",
