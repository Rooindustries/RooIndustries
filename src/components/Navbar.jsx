        ...
        <div ref={navRowRef} className="flex h-20 items-center overflow-visible sm:h-24">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-2 text-sm sm:px-5 sm:py-3 sm:text-base font-semibold whitespace-nowrap rounded-full text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 transition"
            >
              Packages
            </a>
