        ...
        <div ref={navRowRef} className="flex h-20 items-center overflow-visible sm:h-24">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden sm:inline-flex items-center gap-2 px-4 py-2.5 text-base font-semibold whitespace-nowrap rounded-full max-[820px]:px-3 max-[820px]:text-sm max-[820px]:gap-1.5 text-white/70 hover:text-white border border-slate-600/40 transition"
            >
              Discord
            </a>
            <a
