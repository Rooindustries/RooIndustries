...
export default function About({ initialData = null, compact = false }) {
  ...
  if (!aboutData) {
    return (
      ...
      >
        <div
          className={`${compact ? "h-full min-h-[360px]" : "mt-6 min-h-[360px]"} rounded-2xl`}
      ...
      <section id="about" className="h-full text-center">
        ...
        >
          <div
            ...
            style={{
              background: "linear-gradient(to right, transparent, var(--rc-accent), transparent)",
              opacity: 0.35,
            }}
          />
            ...
            <div className="mt-5 grid grid-cols-[minmax(7.5rem,0.42fr)_1fr] items-stretch gap-4 text-left">
              {heroStat && (
                <div className="flex min-w-0 flex-col items-center justify-center px-2 text-center">
                  ...
                  <p
                    className="mt-1 text-4xl font-black leading-none tracking-tight tabular-nums"
